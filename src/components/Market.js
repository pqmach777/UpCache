...
class Market extends React.Component {
    ...
    handleDisplayMarketSearch(){
        ...
        const url = "https://api.ebay.com/commerce/catalog/v1_beta/product_summary/search?q="
        const appID = "PhongMac-imgrecec-PRD-816e08212-d0316206";
        fetch("https://api.ebay.com/commerce/catalog/v1_beta/product_summary/search?q=dog"+ "&appid="+ appID , {
            headers: {
